...
void CMotion::Update(void)
{
	...
	if (m_nType > -1 && m_nType <= m_nNumAll)
	{
		for (int nCnt = 0; nCnt < m_nNumModel; nCnt++)
		{
			...
			//パーツの位置、向きを設定
			D3DXVECTOR3 pos = D3DXVECTOR3(m_Info[m_nType].aKeyInfo[m_nkey].aKey[nCnt].pos_x,
			...
			D3DXVECTOR3 rot = D3DXVECTOR3(m_Info[m_nType].aKeyInfo[m_nkey].aKey[nCnt].rot_x,
