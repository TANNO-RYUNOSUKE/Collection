...
HRESULT CManager::Init(HINSTANCE hinstance, HWND hWnd, BOOL bWindow)
{
	...
	m_pItemManager = DBG_NEW CItemManager;
	m_pItemManager->Init();
...
//リセット関数
//=============================================
void CManager::ReSetItem()
{
	//for (int nCntPry = 0; nCntPry < NUM_PRIORITY; nCntPry++)
	//{
	//	for (int nCnt = 0; nCnt < NUM_OBJECT; nCnt++)
	//	{
	//		CObject * pObj;
	//		pObj = CObject::GetObject(nCntPry, nCnt);
	//		if (pObj != NULL)
	//		{
	...
	//{
	//	CItem::Create(D3DXVECTOR3(nCnt * 100.0f + 50.0f, 300.0f, 0.0f));
	//}
}
//=============================================
//距離取得関数
